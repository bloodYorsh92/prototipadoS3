package XXXNoScope360HeadShot.inputs 
{
	...
	{	
		...
		static private function onKeyUp(e:KeyboardEvent):void 
		{
			switch (e.keyCode) 
			{
				case Keyboard.LEFT:left_down = false;
					
				break;
				
				case Keyboard.RIGHT:right_down = false;
					
				break;
				
				case Keyboard.DOWN:down_down = false;
					
				break;
				
				case Keyboard.UP:up_down = false;
		...
		static private function onKeyDown(e:KeyboardEvent):void 
		{
			switch (e.keyCode) 
			{
				case Keyboard.LEFT:left_down = true;
					
				break;
				
				case Keyboard.RIGHT:right_down = true;
					
				break;
				
				case Keyboard.DOWN:down_down = true;
					
				break;
				
				case Keyboard.UP:up_down = true;
